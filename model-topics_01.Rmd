...
transcripts = transcripts %>%
  ...
  mutate(
      ...
      clean_text = str_replace_all(string = text, pattern = "&#\\d+;", " "),
      clean_text = str_replace_all(string = text, pattern = "&gt;|&lt;|&amp;", " "),
      clean_text = str_replace_all(string = text, pattern = "<[^>]*>", " "),
      clean_text = str_replace_all(string = text, pattern = "(\\n)|(\\r)", " "),
      clean_text = str_replace_all(string = text, pattern = "[[:punct:]]", " "),
